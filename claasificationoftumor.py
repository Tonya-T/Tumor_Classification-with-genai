# -*- coding: utf-8 -*-
"""ClaasificationOfTumor

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1cvK1BtaVH6OVxylqEhh_lwo9h7Eu7TP4
"""
...
# import tensorflow as tf
# from PIL.Image
# import tensorflow.keras.preprocessing.models import load_model
# import tensorflow.keras.preprocessing.image as image
# import numpy as np
# import plotly.graph_objects as go
# import cv2
# from tensorflow.keras.models as import Sequential
# from tensorflow.keras.layers as import Dense, Dropout, Flatten
# from tensorflow.keras.optimizers as import Adamax
# from tensorflow.keras.metrics as import Precision, Recall
# import google.generativeai as genai
# from google.colab import userdara
...
# 
#      prompt=f""" You are expert neurologist. you are tasked with explaining a saliency a brain tumor MRI scan.
...
#        -Explain possible reasons why model made the prediction it did.
#        -Don't mention anything like 'The saliency map highlights the regions the model is focusing on, which are in loght cyan'
...
# 
# def generate_saliency_map(mosel, img_array, class_index, img_size):
...
# gradiants=tf.math.abs(gradients)
# gradiants=tf.reduce.numpy().squeeze()
# 
# 
# gradiants=cv2.resize(gradients, img_size)
# 
# center=(gradients.shape[0] //2, gradients. shape[1] //2)
# redius=min(center[0], center[1])-10
...
#       "Select Model",
#       ("Tranfer Learning-Xception", "Custom CNN")
#   )
# 
# 
...
# 
# 
#   saliency_map_path={'saliency_maps/{uploaded_file.name}'
